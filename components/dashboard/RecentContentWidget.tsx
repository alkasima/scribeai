    ...
    return (
      <div className="w-full md:w-1/2 px-6 py-8">
        <div className="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
          ...
          <div className="mx-5">
            <h4 className="text-2xl font-semibold text-gray-700">Recent Content</h4>
            <div className="mt-4">
              <p className="text-gray-600">Blog Post: "10 Tips for Better Writing"</p>
              <p className="text-gray-600">Social Media Post: "Product Launch Announcement"</p>
              <p className="text-gray-600">Product Description: "New Gadget X Features"</p>
            </div>
          </div>
        </div>
      </div>
