     ...
     <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="bg-blue-600 rounded-lg shadow-xl py-10 px-6 md:py-16 md:px-12 text-center text-white">
            ...
            <a href="/auth/register" className="bg-white text-blue-600 px-8 py-3 rounded-full text-lg font-semibold hover:bg-gray-100 transition duration-300">Start Your Free Trial</a>
          </div>
        </div>
      </section>
    </div>
